<?php
    ...
    class SessionTest extends \PHPUnit_Framework_TestCase
    {
        ...
        public function testMove()
        {
            ...
            $this->assertEquals(array("var1" => "1", "var2" => "2", "var" => "value"), $this->Session->Section2->getIterator());
        }
        ...
        public function testClear()
        {
            ...
            $this->assertEquals(array("var1" => null, "var2" => null, "var3" => null), $this->Session->Section1->getIterator());
        }
