<?php
     ...
     */
    class ElseIfMacro extends BaseMacro
    {
        /**
        ...
        public  function check(Compiler &$compiler)
        {
            ...
            foreach ($macro as $token) {
                if (!in_array($token['token'], $allowedTokens)) {
                    throw new CompileException("The logic expression does contain bad tokens - logic expression is invalid in elseif macro");
